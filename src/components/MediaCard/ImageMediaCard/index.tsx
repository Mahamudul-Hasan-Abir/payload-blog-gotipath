...
import type { Props as MediaProps } from 'src/components/Media/types'
...
export const ImageMediaCard: React.FC<MediaProps> = (props) => {
  const {
    alt: altFromProps,
    fill,
    pictureClassName,
  ...
  return (
    ...
    <div className={cn('relative h-48 w-full', pictureClassName)}>
      <NextImage
        alt={alt || ''}
